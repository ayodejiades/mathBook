...
\Large\textbf{By}\\
\vspace{0.5cm}
\Large\textbf{Ayodeji Adesegun and Jeremaih Nwafor}\\
\vspace{\fill}
\Large{March 2024}\\
\vspace*{\fill}
\end{titlingpage}
...
Ayodeji Adesegun and Jeremaih Nwafor
\clearpage
\end{frontmatter}
