...
\begin{enumerate}[label={\arabic*.}]
  ...
  \item Differentiate: \(\left({x}^{2} + \tfrac{1}{x}\right)^2\) with respect to \(x\).
       \begin{enumerate}[label={\Alph*.}]
            \item \(4{x}^{3} - 2 + \tfrac{2}{{x}^{3}}\)
            \item  \(4{x}^{3} - 2 - \tfrac{2}{{x}^{3}}\)
            \item   \(4{x}^{3} - 4x - \tfrac{2}{x}\)
            \item    \(4{x}^{3} - 3x + \tfrac{2}{x}\)
        \end{enumerate}
...
\item For what value of \(x\) is the tangent to the curve \(y = x^{2} - 4x + 3\) parallel to the \(x\)-axis?
    \begin{enumerate}[label={\Alph*.}]
        ...
        \item \(3\)
    \end{enumerate}   
\item If \(y = x \sin x\), find \( \tfrac{d^2y}{d{x}^{2}} \).
	\begin{enumerate}[label={\Alph*.}]
	\item \(2\cos x - \sin x\)
	\item \(\sin x + \cos x\)
	\item \(\sin x  - \cos  x\)
...
\item If \(y = 2{x}^{3}+6{x}^{2}+6x+1\), find \(\dv{y}{x}\).
	...
	\item \(6{x}^{2}+6{x}+6\)
	\end{enumerate}
\item Find the derivative of \(y ={\left(\tfrac{1}{3}x + 6\right)}^{2}\).
	\begin{enumerate}[label={\Alph*.}]
	\item \(2{\left(\tfrac{1}{3}x + 6\right)}\)
	\item \(\tfrac{2}{3}{\left(\tfrac{1}{3}x + 6\right)}\)
	\item \(\tfrac{1}{3}{\left(\tfrac{1}{3}x + 6\right)}^{2}\)
	\item \(\tfrac{2}{3}{\left(\tfrac{1}{3}x + 6\right)}^{2}\)
	\end{enumerate}
...
\item If \(y = 2x\cos{(2x)}-\sin{(2x)}\), find \(\dv{y}{x}\) when \(x=\tfrac{\pi}{4}\)
	...
	\item \(-{\tfrac{\pi}{2}}\)
	\end{enumerate}
\item Differentiate \(\tfrac{x}{\cos x}\) with respect to \(x\)
	\begin{enumerate}[label={\Alph*.}]
	\item \(1 + \sec^{2}x\)
	\item \(1 + x\tan x\sec x\)
	\item \(\cos x + x\tan x \)
...
\item Differentiate \(y = \sqrt[3]{{x}^{2}}(2x-{x}^{2})\)
	\begin{enumerate}[label={\Alph*.}]
	\item \(\tfrac{10{x}^{\tfrac{5}{3}}}{3} -\tfrac{10{x}^{\tfrac{5}{3}}}{3} \)
	\item \(\tfrac{10{x}^{\tfrac{5}{3}}}{3} -\tfrac{10{x}^{\tfrac{5}{3}}}{3} \)
	\item \(\tfrac{10{x}^{\tfrac{5}{3}}}{3} -\tfrac{10{x}^{\tfrac{5}{3}}}{3} \)
	\item \(\tfrac{10{x}^{\tfrac{5}{3}}}{3} -\tfrac{10{x}^{\tfrac{5}{3}}}{3} \)
	\end{enumerate}
