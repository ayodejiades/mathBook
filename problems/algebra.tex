...
\begin{multicols}{2}
  \begin{enumerate}[label={\arabic*.}]
    ...
    \item Multiply \((x + 3y + 5)\) by \((2{x}^{2} + 5y + 2)\).
      ...
      \end{enumerate}
    \item If \(k{x}^{3} +   10{x}^{2} + lx - 3\) is divisible by \((x - 1)\) and when it is divided by \((x + 2)\) the remainder is 27,
      find the constants \(k\) and \(l\).
      \begin{enumerate}[label={\Alph*.}]
        \item \(k = -7, l = -15\)
    ...
    \item Factorize completely: \(81a^4-16b^4\).
      \begin{enumerate}[label={\Alph*.}]
        ...
        \item \((3a-2b)(3a+2b)(9a^2+4b^2)\)
      \end{enumerate}
    \item The factor which is common to all three bionomial expressions \(4a^2-9b^2\), \(8a^2+27b^3\), \({(4a+6b)}^2\) is:
      \begin{enumerate}[label={\Alph*.}]
        \item \(4a-6b\)
        \item \(4a+6b\)
        \item \(2a-3b\)
        ...
        \item \(3a-2b\)
      \end{enumerate}
    \item If \(x-2\) and \(x+1\) are factors of the expression \({x}^{3}+p{x}^{2}+qx+1\), find \(p+q\).
      \begin{enumerate}[label={\Alph*.}]
        \item \(-3\)
        \item \(0\)
        \item \(-\dfrac{17}{3}\)
    ...
    \item If \({x}^{3} - 12x - 16 = 0\) has \(x-2\) as a solution, then the equation has:
      \begin{enumerate}[label={\Alph*.}]
        ...
        \item only one root
      \end{enumerate}
    \item The expression \({x}^{3}-4{x}^{2}+cx+d\) is such that \(x+1\) is a factor and its value is \(1\) when \(x\) is \(-2\). Find \(c\) and \(d\).
      \begin{enumerate}[label={\Alph*.}]
        \item \(c = -4\) and \(d = 9\)
        \item \(c = 20\) and \(d  = 9\)
        \item \(c = -20\) and \(d = 15\)
    ...
    \item Divide the expression \(x^3 + 7x^2 -x -7\) by \(-1 + x^2\).
      \begin{enumerate}[label={\Alph*.}]
        ...
        \item \(-x^2 + 7x + 7\)
      \end{enumerate}
    \item Find a positive value of \(p\) if the expression \(2x^2 - px + p\) leaves a remainder \(6\) when divided by \(x-p\).
      \begin{enumerate}[label={\Alph*.}]
        \item \(1\)
        \item \(2\)
        \item \(3\)
    ...
    \item Divide \(4x^3 - 3x + 1\) by \(2x -1\).
      \begin{enumerate}[label={\Alph*.}]
        ...
        \item \(2x^2 +x + 1\)
      \end{enumerate}
    \item If \((x-1)\), \((x+1)\) and \((x-2)\) are factors of the polynomial \(ax^3 + bx^2 +cx -1\), find \(a\), \(b\), and \(c\) respectively.
      \begin{enumerate}[label={\Alph*.}]
    ...
    \item The polynomial whose roots are \(-2\), \(-1\) and \(3\) is:
      \begin{enumerate}[label={\Alph*.}]
        ...
        \item \(x^3 +7x +6\)
      \end{enumerate}
    \item Find the value of \(k\) if the expression \(kx^3 + x^2 -5x -2\) leaves a remainder of \(2\) when divided by \(2x+1\).
      \begin{enumerate}[label={\Alph*.}]
        \item \(10\)
        \item \(-8\)
        \item \(-10\)
    ...
    \item Divide the expression \(x^3 + 7x^2 -x - 7\) by \(x^2-1\).
      \begin{enumerate}[label={\Alph*.}]
        ...
        \item \(x+7\)
      \end{enumerate}
    \item If \(x+a\) is a factor of the polynomial \(x^3 +ax^2 -2x +a + 4\), find the value of \(a\).
      \begin{enumerate}[label={\Alph*.}]
        \item \(-\cfrac{4}{3}\)
        \item \(\cfrac{4}{3}\)
        \item \(\cfrac{2}{3}\)
    ...
    \item What is the value of \(\cfrac{(a^2 + b^2)(a-b) - {(a-b)}^3}{a^2b - ab^2}\)?
      \begin{enumerate}[label={\Alph*.}]
        ...
        \item \(2\)
      \end{enumerate}
    \item Find the values of \(m\) and \(n\) in the polynomial \(2x^3 + mx^2 + nx -14\), such that \((x-1)\) and \((x+2)\) are its factors.
      \begin{enumerate}[label={\Alph*.}]
        \item \(m = 4, n = 5\)
        \item \(m = 9, n =3\)
        \item \(m = 6, n = 7\)
