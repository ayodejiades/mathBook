...
\include{number}
%\include{numberSolution}
\include{fraction}
%\include{fractionSolution}
\include{algebra}
%\include{algebraSolution}
\include{indices}
%\include{indicesSolution}
\include{surds}
%\include{surdSolution}
\include{logarithms}
%\include{logarithmsSolution}
\include{geometry}
%\include{geometrySolution}
\include{coordinate}
%\include{coordinateSolution}
\include{differentiation}
\include{differentiationSolution}
\include{integration}
%\include{integrationSolution}
\include{combinatorics}
%\include{combinatoricsSolution}
\include{probability}
%\include{probabilitySolution}
\include{statistics}
%\include{statisticsSolution}
\include{things}
