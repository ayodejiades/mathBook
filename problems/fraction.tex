...
\item If a car travels \(120\)km on \(45\) litres of petrol, how much petrol is needed for a journey of \(600\)km?
    ...
    \item \(160\) litres
    \end{enumerate}
\item Simplify \(1 - \left(\dfrac{1}{7} \times 3\dfrac{1}{2}\right) \div \dfrac{3}{4}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(2\)
    \item \(1\)
    \item \(\dfrac{1}{3}\)
...
month. Find his salary in the eight month of the third year. 
    ...
    \item \(684\)
    \end{enumerate}
\item Find correct to 3 decimal places: \[\left(\dfrac{1}{0.05}\right)\div \left(\dfrac{1}{5.005}\right) -(0.05 \times 2.05)\]
    \begin{enumerate}[label={\Alph*.}]
    \item \(99.998\)
    \item \(9.998\)
    \item \(98.999\)
    \item \(89.899\)
    \end{enumerate}
\item Express 62 $ \div$ 3 as a decimal correct to 3 significant figures.
    \begin{enumerate}[label={\Alph*.}]
    \item \(20.667\)
    \item \(20.6\)
    \item \(20.7\)
...
\item If 3 gallons of spirit containing $20\%$ water are added to 5 gallons of another spirit containing $15\%$ water, what percentage of the mixture is water?
    ...
    \item \(16\,\dfrac{7}{8}\)
    \end{enumerate} 
\item The radius of a circle is given as 5cm subject to an error of 0.1cm. What is the percentage error in the area of the circle.
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{1}{4}\)
    \item \(\dfrac{1}{25}\)
    \item \(25\)
...
\item Evaluate $\dfrac{3524}{0.05}$ correct to 3 significant figures
    \begin{enumerate}[label={\Alph*.}]
    \item \(70000\)
    \item \(70480\)
    \item \(705\)
...
\item A man's initial salary is N$540$ a month and increases after each period of six month by N$36$ a month. Find his salary in the eighth month of the third year.
    \begin{enumerate}[label={\Alph*.}]
    \item N\(756\)
    \item N\(648\)
    \item N\(720\)
...
\item \(\dfrac{1}{3} \div \left[\dfrac{5}{7}\left(\dfrac{9}{10} - 1 + \dfrac{3}{4}\right)\right]\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{13}{24}\)
    \item \(\dfrac{39}{28}\)
    \item \(\dfrac{28}{39}\)
...
\item The prime factors of $2,520$ are.
    \begin{enumerate}[label={\Alph*.}]
    \item \(2,3,5,7\)
    \item \(2,9,5\)
    \item \(2,3,7,9\)
...
\item Simplify: \(\dfrac{2}{3} + \dfrac{3}{4} - \dfrac{5}{6}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{7}{12}\)
    \item \(\dfrac{5}{12}\)
    \item \(\dfrac{11}{12}\)
...
\item A man sells a radio for N\(1,200\) at a loss of 20\%. How much did he buy it?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(1,500\)
    \item N\(1,440\)
    \item N\(1,000\)
...
\item Express \(0.0462\) in standard form.
    \begin{enumerate}[label={\Alph*.}]
    \item \(4.62 \times 10^{-2}\)
    \item \(4.62 \times 10^{-3}\)
    \item \(46.2 \times 10^{-3}\)
...
\item If \(\dfrac{2}{3}\) of a number is 30, what is \(\dfrac{3}{5}\) of that number?
    \begin{enumerate}[label={\Alph*.}]
    \item \(27\)
    \item \(20\)
    \item \(45\)
...
\item A discount of 15\% on the marked price of an article amounts to N\(450\). What is the marked price?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(3,000\)
    \item N\(3,500\)
    \item N\(2,500\)
...
\item A worker's salary was increased by 25\%. If his new salary is N\(2,500\), what was his old salary?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(2,000\)
    \item N\(2,250\)
    \item N\(1,875\)
...
\item Simplify: \(\dfrac{0.0324 \times 0.00064}{0.48 \times 0.012}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(0.0036\)
    \item \(0.036\)
    \item \(0.36\)
...
\item What is the simple interest on N\(5,000\) for 3 years at 4\% per annum?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(600\)
    \item N\(500\)
    \item N\(650\)
...
\item If \(x:y = 2:3\) and \(y:z = 4:5\), find \(x:z\).
    \begin{enumerate}[label={\Alph*.}]
    \item \(8:15\)
    \item \(10:15\)
    \item \(8:12\)
...
\item Express \(\dfrac{5}{8}\) as a decimal.
    \begin{enumerate}[label={\Alph*.}]
    \item \(0.625\)
    \item \(0.650\)
    \item \(0.725\)
...
\item A man bought 20 articles at N\(50\) each and sold them at N\(60\) each. What is his percentage profit?
    \begin{enumerate}[label={\Alph*.}]
    \item \(10\%\)
    \item \(20\%\)
    \item \(15\%\)
...
\item Evaluate: \(2.5 \times 0.04 \times 0.5\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(0.05\)
    \item \(0.5\)
    \item \(0.005\)
...
\item The HCF of 72, 96 and 108 is
    \begin{enumerate}[label={\Alph*.}]
    \item \(12\)
    \item \(24\)
    \item \(18\)
...
\item Simplify: \(3\dfrac{1}{4} \div 1\dfrac{1}{2}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(2\dfrac{1}{6}\)
    \item \(1\dfrac{5}{6}\)
    \item \(2\dfrac{1}{2}\)
...
\item A sum of N\(8,000\) is invested at 5\% compound interest per annum. What is the amount after 2 years?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(8,820\)
    \item N\(8,800\)
    \item N\(8,640\)
...
\item Express 0.0000375 in standard form.
    \begin{enumerate}[label={\Alph*.}]
    \item \(3.75 \times 10^{-5}\)
    \item \(3.75 \times 10^{-4}\)
    \item \(37.5 \times 10^{-6}\)
...
\item If \(\dfrac{3}{4}\) of a class are girls and \(\dfrac{2}{3}\) of the girls are tall, what fraction of the class are tall girls?
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{1}{2}\)
    \item \(\dfrac{5}{12}\)
    \item \(\dfrac{2}{3}\)
...
\item A man earns N\(15,000\) monthly. If 12\% is deducted for tax, how much does he take home?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(13,200\)
    \item N\(13,800\)
    \item N\(14,000\)
...
\item Simplify: \(\dfrac{3}{7} \times \dfrac{14}{9} \div \dfrac{2}{3}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(1\)
    \item \(2\)
    \item \(\dfrac{1}{2}\)
...
\item What percentage of 250 is 75?
    \begin{enumerate}[label={\Alph*.}]
    \item \(30\%\)
    \item \(25\%\)
    \item \(20\%\)
...
\item The LCM of 12, 18, and 24 is
    \begin{enumerate}[label={\Alph*.}]
    \item \(72\)
    \item \(144\)
    \item \(48\)
...
\item A man bought a car for N\(800,000\) and sold it for N\(920,000\). What is his percentage gain?
    \begin{enumerate}[label={\Alph*.}]
    \item \(15\%\)
    \item \(12\%\)
    \item \(20\%\)
...
\item Express \(2\dfrac{3}{5}\) as a decimal.
    \begin{enumerate}[label={\Alph*.}]
    \item \(2.6\)
    \item \(2.3\)
    \item \(2.5\)
...
\item If N\(1,200\) amounts to N\(1,440\) in 2 years at simple interest, what is the rate per annum?
    \begin{enumerate}[label={\Alph*.}]
    \item \(10\%\)
    \item \(12\%\)
    \item \(8\%\)
...
\item Simplify: \(\left(\dfrac{2}{3}\right)^2 + \left(\dfrac{1}{4}\right)^2\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{25}{36}\)
    \item \(\dfrac{17}{36}\)
    \item \(\dfrac{73}{144}\)
...
\item A bag of rice costs N\(8,000\). If the price increases by 12.5\%, what is the new price?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(9,000\)
    \item N\(9,500\)
    \item N\(8,500\)
...
\item Find the value of \(x\) if \(\dfrac{x}{5} = \dfrac{12}{15}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(4\)
    \item \(5\)
    \item \(6\)
...
\item Simplify: \(5\dfrac{1}{3} - 2\dfrac{5}{6}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(2\dfrac{1}{2}\)
    \item \(2\dfrac{1}{3}\)
    \item \(3\dfrac{1}{6}\)
...
\item Express 456 as a product of its prime factors.
    \begin{enumerate}[label={\Alph*.}]
    \item \(2^3 \times 3 \times 19\)
    \item \(2^2 \times 3^2 \times 19\)
    \item \(2 \times 3 \times 76\)
    \item \(2^3 \times 57\)
    \end{enumerate}

\item A man invested N\(50,000\) at 6\% simple interest. How much interest will he earn in 4 years?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(12,000\)
    \item N\(10,000\)
    \item N\(15,000\)
...
\item Evaluate: \(\dfrac{2.5 + 3.7}{1.2 - 0.4}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(7.75\)
    \item \(6.2\)
    \item \(8.0\)
...
\item If \(a:b = 3:4\) and \(b:c = 2:5\), find \(a:b:c\).
    \begin{enumerate}[label={\Alph*.}]
    \item \(3:4:10\)
    \item \(6:8:20\)
    \item \(3:4:5\)
...
\item A trader bought goods worth N\(45,000\) and sold them for N\(54,000\). What is his profit percentage?
    \begin{enumerate}[label={\Alph*.}]
    \item \(20\%\)
    \item \(15\%\)
    \item \(18\%\)
...
\item Express \(\dfrac{7}{20}\) as a percentage.
    \begin{enumerate}[label={\Alph*.}]
    \item \(35\%\)
    \item \(30\%\)
    \item \(40\%\)
...
\item Evaluate: \(0.5 \times 0.5 \times 0.5\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(0.125\)
    \item \(0.25\)
    \item \(0.5\)
...
\item The sum of N\(6,000\) invested at 5\% simple interest amounts to N\(7,500\). For how many years was it invested?
    \begin{enumerate}[label={\Alph*.}]
    \item \(5\) years
    \item \(4\) years
    \item \(6\) years
...
\item Simplify: \(\dfrac{5}{8} + \dfrac{3}{4} - \dfrac{7}{16}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{15}{16}\)
    \item \(\dfrac{13}{16}\)
    \item \(\dfrac{11}{16}\)
...
\item What is 15\% of 15\% of N\(20,000\)?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(450\)
    \item N\(300\)
    \item N\(500\)
...
\item Express 2.75 as a fraction in its simplest form.
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{11}{4}\)
    \item \(\dfrac{7}{3}\)
    \item \(\dfrac{9}{4}\)
...
\item A man's salary was reduced by 10\% to N\(27,000\). What was his original salary?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(30,000\)
    \item N\(29,700\)
    \item N\(28,500\)
...
\item Evaluate: \(\dfrac{3.6 \times 2.4}{0.8 \times 0.9}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(12\)
    \item \(10\)
    \item \(15\)
...
\item If \(\dfrac{5}{x} = \dfrac{15}{27}\), find \(x\).
    \begin{enumerate}[label={\Alph*.}]
    \item \(9\)
    \item \(8\)
    \item \(10\)
...
\item Simplify: \(6\dfrac{2}{5} - 3\dfrac{3}{10} + 1\dfrac{1}{2}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(4\dfrac{3}{5}\)
    \item \(4\dfrac{1}{5}\)
    \item \(5\dfrac{3}{10}\)
...
\item A discount of 12\% on a dress amounts to N\(840\). What is the marked price of the dress?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(7,000\)
    \item N\(6,500\)
    \item N\(8,000\)
...
\item Simplify: \(\dfrac{2}{3} \div \dfrac{4}{9} \times \dfrac{6}{5}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(2\)
    \item \(\dfrac{9}{5}\)
    \item \(1\)
...
\item Express 0.0625 as a fraction in its lowest terms.
    \begin{enumerate}[label={\Alph*.}]
    \item \(\dfrac{1}{16}\)
    \item \(\dfrac{1}{8}\)
    \item \(\dfrac{5}{8}\)
...
\item A sum of N\(10,000\) is shared between A and B in the ratio 3:2. How much does B receive?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(4,000\)
    \item N\(5,000\)
    \item N\(3,000\)
...
\item Evaluate: \(5.4 + 3.27 - 1.89\), correct to 1 decimal place.
    \begin{enumerate}[label={\Alph*.}]
    \item \(6.8\)
    \item \(6.7\)
    \item \(7.0\)
...
\item What is 25\% of 40\% of N\(8,000\)?
    \begin{enumerate}[label={\Alph*.}]
    \item N\(800\)
    \item N\(600\)
    \item N\(1,000\)
...
\item Simplify: \(4\dfrac{1}{2} \times 2\dfrac{2}{3}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(12\)
    \item \(11\)
    \item \(10\)
...
\item The LCM of 15, 20, and 25 is
    \begin{enumerate}[label={\Alph*.}]
    \item \(300\)
    \item \(150\)
    \item \(100\)
...
\item A man bought a bicycle for N\(12,000\) and spent N\(3,000\) on repairs. If he sold it for N\(18,000\), what is his percentage profit?
    \begin{enumerate}[label={\Alph*.}]
    \item \(20\%\)
    \item \(25\%\)
    \item \(30\%\)
...
\item Express \(\dfrac{13}{25}\) as a decimal.
    \begin{enumerate}[label={\Alph*.}]
    \item \(0.52\)
    \item \(0.48\)
    \item \(0.56\)
