...
\usepackage[left=.7in, right=.7in, top=1.2in, bottom=1in]{geometry} % Adjust margins for better readability
...
\vspace{0.5cm}
<<<<<<< HEAD
\textbf{Ayodeji Adesegun and Chimobi Nwafor}\\
=======
...
\include{number.tex}
%\include{numberSolution.tex}
\include{fraction.tex}
%\include{fractionSolution.tex}
\include{algebra.tex}
%\include{algebraSolution.tex}
\include{indices.tex}
%\include{indicesSolution.tex}
\include{surds.tex}
%\include{surdSolution.tex}
\include{logarithms.tex}
%\include{logarithmsSolution.tex}
...
%\include{probabilitySolution.tex}
