...
\item \textbf{B. $32.0^\circ$} ($\sin\theta = 8/17$, $\theta \approx 28°$, so angle with tangent $\approx 32°$)
...
\item \textbf{A. $22.5^\circ$} (Angle on major arc $= (360-45)/2 = 157.5°$... recalculation needed)
...
\item \textbf{C. $120^\circ$} (Quadrilateral with two right angles and $60°$: remaining = $120$)

\item \textbf{A. $50^\circ$} (Angle at circumference on reflex arc $= (360-100)/2 = 130°$... needs recalculation for major arc: angle $= 100/2 = 50°$)
