...
\item Divide the LCM of 48, 64, and 80 by their HCF.
    ...
    \item \(60\)
    \end{enumerate}
\item A sum of money was invested at 8\% per annum simple interest. If after 4years the money amounts to N330.00, find the amount originally invested.
    \begin{enumerate}[label={\Alph*.}]
    \item N\(150\)
    \item N\(200\)
    \item N\(165\)
...
\item A rectangular lawn has an area of 1815 square yards. If its length is 50 metres, find its width in meters. Given that 1 metre equals 1.1 yard.
    ...
    \item \(\SI{36.45}{\meter}\)
    \end{enumerate}
\item Reduce each number to two significant figure and then evaluate \(\dfrac{0.021741 \times 1.2047}{0.023789}\)
    \begin{enumerate}[label={\Alph*.}]
    \item \(0.8\)
    \item \(1.2\)
    \item \(1.1\)
...
month. Find his salary in the eight month of the third year. 
    ...
    \item \(684\)
    \end{enumerate}
\item Find correct to 3 decimal places: \(\left(\dfrac{1}{0.05}\right)/\left(\dfrac{1}{5.005}\right)\) -(0.05 \(\times\) 2.05)
    \begin{enumerate}[label={\Alph*.}]
    \item \(\)
    \item \(\)
    \item \(\)
